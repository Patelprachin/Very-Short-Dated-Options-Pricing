...
[X, RESNORM, RESIDUAL, EXITFLAG] = lsqnonlin(@(x) calibration_Heston(x, Mkt_mid, S, K, r, T, vega, Nq, OptionType), Init_param, LB, UB, options);

% Get the Heston prices with the optimized parameters
...
function RMSE = calibration_Heston(params, Mkt_mid, S, K, r, T, vega, Nq, OptionType)
