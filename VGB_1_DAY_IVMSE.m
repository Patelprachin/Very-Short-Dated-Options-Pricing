...
[X, RESNORM, RESIDUAL, EXITFLAG] = lsqnonlin(@(x) calibration_VGB(x, Mkt_iv, S, K, r, T, OptionType, Nq), Init_param, LB, UB, options);
...
Difference_in_IV = Mkt_iv - VGB_IVs;
Difference_in_Pct = (Difference_in_IV ./ Mkt_iv) * 100;

% Create and display the results table
results_table = table(K, Mkt_iv, VGB_IVs, Difference_in_IV, Difference_in_Pct);
disp(results_table);
...
hold on;
plot(moneyness, VGB_IVs, 'r*-', 'LineWidth', 1.5, 'MarkerSize', 8, 'DisplayName', 'VGB Model IV');
